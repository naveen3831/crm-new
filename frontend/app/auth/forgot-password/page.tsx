...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center px-4 py-8 sm:py-12 hero-gradient">
      <div className="w-full max-w-sm sm:max-w-md bg-white border border-teal-200/90 shadow-2xl rounded-2xl p-6 sm:p-8 transition-all">
        
        {/* Brand Header */}
        <div className="flex flex-col items-center gap-3 mb-6 text-center">
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-teal-50 to-slate-100 border border-teal-200/80 flex items-center justify-center shadow-md p-2.5">
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleVerifyEmail} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="forgot-email" className="text-xs font-bold text-teal-700 font-sans tracking-wide uppercase">
            ...
            <div className="text-center pt-2">
              <Link href="/auth/login" className="inline-flex items-center gap-1.5 text-xs font-bold text-teal-600 hover:text-[#071E34] transition-colors">
                <ArrowLeft size={14} />
          ...
          <form onSubmit={handleResetPassword} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="new-password" className="text-xs font-bold text-teal-700 font-sans tracking-wide uppercase">
                NEW PASSWORD *
              </label>
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full pl-10 pr-11 py-3 rounded-xl bg-white border border-teal-200 text-[#071E34] text-sm font-medium transition-all placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-teal-500"
                />
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirm-new-password" className="text-xs font-bold text-teal-700 font-sans tracking-wide uppercase">
